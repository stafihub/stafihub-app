...
export const GetNodeInfoResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetNodeInfoResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.nodeInfo = DefaultNodeInfo.decode(reader, reader.uint32());
          break;
        case 2:
  ...
  fromJSON(object: any): GetNodeInfoResponse {
    ...
    message.nodeInfo =
      object.nodeInfo !== undefined && object.nodeInfo !== null
        ? DefaultNodeInfo.fromJSON(object.nodeInfo)
        : undefined;
    message.applicationVersion =
  ...
  toJSON(message: GetNodeInfoResponse): unknown {
    ...
    message.nodeInfo !== undefined &&
      (obj.nodeInfo = message.nodeInfo
        ? DefaultNodeInfo.toJSON(message.nodeInfo)
        : undefined);
  ...
  fromPartial(object: DeepPartial<GetNodeInfoResponse>): GetNodeInfoResponse {
    ...
    message.nodeInfo =
      object.nodeInfo !== undefined && object.nodeInfo !== null
        ? DefaultNodeInfo.fromPartial(object.nodeInfo)
        : undefined;
    message.applicationVersion =
      object.applicationVersion !== undefined &&
      object.applicationVersion !== null
