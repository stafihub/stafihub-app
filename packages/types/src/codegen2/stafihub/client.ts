...
import * as rvalidatorTxRegistry from "../rvalidator/tx.registry";
...
import * as rvalidatorTxAmino from "../rvalidator/tx.amino";
export const stafihubAminoConverters = { ...bridgeTxAmino.AminoConverter,
  ...
  ...rvalidatorTxAmino.AminoConverter
};
export const stafihubProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...bridgeTxRegistry.registry, ...claimTxRegistry.registry, ...ledgerTxRegistry.registry, ...miningTxRegistry.registry, ...rdexTxRegistry.registry, ...rmintrewardTxRegistry.registry, ...rvalidatorTxRegistry.registry];
