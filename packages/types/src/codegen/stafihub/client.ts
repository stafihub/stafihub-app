...
export const stafihubProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...bridgeTxRegistry.registry, ...claimTxRegistry.registry, ...ledgerTxRegistry.registry, ...miningTxRegistry.registry, ...rdexTxRegistry.registry, ...rmintrewardTxRegistry.registry];
